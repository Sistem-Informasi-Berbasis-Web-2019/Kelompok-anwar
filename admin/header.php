		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse">				
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a class="dropdown-toggle" data-toggle="dropdown" role="button" href="#">Hy , <?php echo $_SESSION['nama']  ?>&nbsp&nbsp<span class="glyphicon glyphicon-user"></span></a></li>
				</ul>
			</div>
		</div>
	</div>
...
<div class="col-md-2">
		...
		<ul class="nav nav-pills nav-stacked">
			...
			<li><a href="distributor.php"><span class="glyphicon glyphicon-briefcase"></span>  Data Distributor</a></li>
			...
			<li><a href="pembelian.php"><span class="glyphicon glyphicon-briefcase"></span>  Entry Pasok Buku</a></li> 
			<li><a href="kasir.php"><span class="glyphicon glyphicon-briefcase"></span>  Data Kasir</a></li>   

	...
	foreach ($prepare as $data) :
		...
		<tr>
			...
			<td>
				...
				<a onclick="if(confirm('Apakah anda yakin ingin menghapus data ini ??')){ location.href='hapus_data_penjualan.php?id_penjualan=<?php echo $data['id_penjualan']; ?>' }" class="btn btn-danger">Hapus</a>

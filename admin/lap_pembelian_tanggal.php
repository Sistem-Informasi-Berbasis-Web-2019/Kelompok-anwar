...
$pdf->Cell(0,0.7,'Laporan Data Pemasokan Buku Berdasarkan Tanggal',0,0,'C');
$pdf->ln(1);
$pdf->SetFont('Arial','B',10);
$pdf->Cell(5,0.7,"Di cetak pada : ".date("D-d/m/Y"),0,0,'C');
$pdf->ln(1);
$pdf->Cell(6,0.7,"Laporan Pemasokan Buku pada : ".$_GET['tanggal'],0,0,'C');
$pdf->ln(1);
...
$tanggal=$_GET['tanggal'];
	$qu = "SELECT * from lap_pembelian where tanggal=" . $tanggal;
   $no=1;
